...
@protocol DMCCommentMessageToolBarDelegate;

@interface DMCCommentMessageToolBar : UIView


@property (nonatomic, weak) id <DMCCommentMessageToolBarDelegate> delegate;
...
@protocol DMCCommentMessageToolBarDelegate <NSObject>
