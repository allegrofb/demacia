//
//  DMCCommentMessageToolBar.m
//  Demacia
//
//  Created by Hongyong Jiang on 30/10/14.
...
@interface DMCCommentMessageToolBar()<UITextViewDelegate, DXFaceDelegate>
{
...
@implementation DMCCommentMessageToolBar
...
//    allButtonWidth += CGRectGetWidth(self.moreButton.frame) + kHorizontalPadding * 2.5;
    ...
    //表情
    self.faceButton = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight, kVerticalPadding, kInputTextViewMinHeight, kInputTextViewMinHeight)];
