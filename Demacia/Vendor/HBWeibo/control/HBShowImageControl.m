...
//    }
    ...
    [imageView setImageWithURL:file.url layout:UIImageViewLayoutNone placeholderImage:nil process:nil complete:^(UIImage * image, NSData * data,  NSError *error, BOOL finish) {
        [indicator stopAnimating];
        [indicator removeFromSuperview];
        UITapGestureRecognizer * tap=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(lookImageAction:)];
